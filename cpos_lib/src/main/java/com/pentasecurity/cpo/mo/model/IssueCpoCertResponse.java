...
public class IssueCpoCertResponse {
	...
	public IssueCpoCertResponse(String subjectCN, String serial, String certificateData) {
		this.subjectCN = subjectCN;
		this.serial = serial;
		this.certificateData = certificateData;
	}
	...
	public String toString() {
		return "IssueTlsCertResponse [subjectCN=" + subjectCN + ", serial=" + serial + ", certificateData="
				+ certificateData + "]";
	}
