...
public class SignedInfoType {
    ...
    @XmlElement(name = "CanonicalizationMethod", required = true, namespace = "http://www.w3.org/2000/09/xmldsig#")
    protected CanonicalizationMethodType canonicalizationMethod;
    @XmlElement(name = "SignatureMethod", required = true, namespace = "http://www.w3.org/2000/09/xmldsig#")
...
//    protected String id;
    ...
    public void setReference(List<ReferenceType> references) {
